...
import com.TeamGorila.View.Jframe.Mainly.swing.MenuButton;
import com.TeamGorila.View.Jframe.Mainly.theme.SystemTheme;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void addMenu(String menuName, String icon, int index) {
        ...
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("/com/TeamGorila/View/Jframe/Mainly/LocalResource/icon/" + icon + ".png")));
        ...
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                if (!c.getIcoName().contains("_s")) {
                    c.setIcon(new ImageIcon(getClass().getResource("/com/TeamGorila/View/Jframe/Mainly/LocalResource/icon/" + c.getIcoName() + ".png")));
                }
            }
        }
    }
    ...
    public void setSelectedMenu(int index) {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/TeamGorila/View/Jframe/Mainly/LocalResource/icon/" + cmd.getIcoName() + "_s.png")));
    }
    ...
    private void initComponents() {
        ...
        imageAvatar1 = new com.TeamGorila.View.Jframe.Mainly.theme.ImageAvatar();
    ...
    private com.TeamGorila.View.Jframe.Mainly.theme.ImageAvatar imageAvatar1;
